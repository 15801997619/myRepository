...
<#macro generatePkProperties>
	...
	//@Id @GeneratedValue(generator="SEQ_${column.sqlName}",strategy=GenerationType.SEQUENCE)
	//@SequenceGenerator(name="SEQ_${column.sqlName}",sequenceName="SEQ_${column.sqlName}",allocationSize=1)
